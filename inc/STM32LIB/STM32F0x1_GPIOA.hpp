#ifndef STM32F0X1_GPIOA_HPP_
#define STM32F0X1_GPIOA_HPP_
#pragma once
...
public:
    ...
    GPIOA() = default;
    GPIOA( const GPIOA& ) = delete;
    const GPIOA& operator=( const GPIOA& ) = delete;

    class MODER_T : public Register::Register<GPIOA_MODER::moder_reg_type, BASE_ADDRESS + MODER_Offset> {
    ...
    class OTYPER_T : public Register::Register<GPIOA_OTYPER::otyper_reg_type, BASE_ADDRESS + OTYPER_Offset> {
    ...
    class OSPEEDR_T : public Register::Register<GPIOA_OSPEEDR::ospeedr_reg_type, BASE_ADDRESS + OSPEEDR_Offset> {
    ...
    class PUPDR_T : public Register::Register<GPIOA_PUPDR::pupdr_reg_type, BASE_ADDRESS + PUPDR_Offset> {
    ...
    class IDR_T : public Register::Register<GPIOA_IDR::idr_reg_type, BASE_ADDRESS + IDR_Offset> {
    ...
    class ODR_T : public Register::Register<GPIOA_ODR::odr_reg_type, BASE_ADDRESS + ODR_Offset> {
    ...
    class BSRR_T : public Register::Register<GPIOA_BSRR::bsrr_reg_type, BASE_ADDRESS + BSRR_Offset> {
    ...
    class LCKR_T : public Register::Register<GPIOA_LCKR::lckr_reg_type, BASE_ADDRESS + LCKR_Offset> {
    ...
    class AFRL_T : public Register::Register<GPIOA_AFRL::afrl_reg_type, BASE_ADDRESS + AFRL_Offset> {
    ...
    class AFRH_T : public Register::Register<GPIOA_AFRH::afrh_reg_type, BASE_ADDRESS + AFRH_Offset> {
    ...
    class BRR_T : public Register::Register<GPIOA_BRR::brr_reg_type, BASE_ADDRESS + BRR_Offset> {
