#ifndef STM32F0X1_TIM2_HPP_
#define STM32F0X1_TIM2_HPP_
#pragma once
...
public:
    ...
    TIM2() = default;
    TIM2( const TIM2& ) = delete;
    const TIM2& operator=( const TIM2& ) = delete;

    class CR1_T : public Register::Register<TIM2_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // control register 1
    public:
    ...
    class CR2_T : public Register::Register<TIM2_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // control register 2
    public:
    ...
    class SMCR_T : public Register::Register<TIM2_SMCR::smcr_reg_type, BASE_ADDRESS + SMCR_Offset> {
    ...
    class DIER_T : public Register::Register<TIM2_DIER::dier_reg_type, BASE_ADDRESS + DIER_Offset> {
    ...
    class SR_T : public Register::Register<TIM2_SR::sr_reg_type, BASE_ADDRESS + SR_Offset> {
    // status register
    public:
    ...
    class EGR_T : public Register::Register<TIM2_EGR::egr_reg_type, BASE_ADDRESS + EGR_Offset> {
    ...
    class CCMR1_Output_T : public Register::Register<TIM2_CCMR1_Output::ccmr1_output_reg_type, BASE_ADDRESS + CCMR1_Output_Offset> {
    ...
    class CCMR1_Input_T : public Register::Register<TIM2_CCMR1_Input::ccmr1_input_reg_type, BASE_ADDRESS + CCMR1_Input_Offset> {
    ...
    class CCMR2_Output_T : public Register::Register<TIM2_CCMR2_Output::ccmr2_output_reg_type, BASE_ADDRESS + CCMR2_Output_Offset> {
    ...
    class CCMR2_Input_T : public Register::Register<TIM2_CCMR2_Input::ccmr2_input_reg_type, BASE_ADDRESS + CCMR2_Input_Offset> {
    ...
    class CCER_T : public Register::Register<TIM2_CCER::ccer_reg_type, BASE_ADDRESS + CCER_Offset> {
    ...
    class CNT_T : public Register::Register<TIM2_CNT::cnt_reg_type, BASE_ADDRESS + CNT_Offset> {
    // counter
    public:
    ...
    class PSC_T : public Register::Register<TIM2_PSC::psc_reg_type, BASE_ADDRESS + PSC_Offset> {
    // prescaler
    public:
        Register::Bitfield<BASE_ADDRESS + PSC_Offset, 0, 16, PSC_PSC_T> PSC; /* Prescaler value */
    };

    class ARR_T : public Register::Register<TIM2_ARR::arr_reg_type, BASE_ADDRESS + ARR_Offset> {
    ...
    class CCR1_T : public Register::Register<TIM2_CCR1::ccr1_reg_type, BASE_ADDRESS + CCR1_Offset> {
    ...
    class CCR2_T : public Register::Register<TIM2_CCR2::ccr2_reg_type, BASE_ADDRESS + CCR2_Offset> {
    ...
    class CCR3_T : public Register::Register<TIM2_CCR3::ccr3_reg_type, BASE_ADDRESS + CCR3_Offset> {
    ...
    class CCR4_T : public Register::Register<TIM2_CCR4::ccr4_reg_type, BASE_ADDRESS + CCR4_Offset> {
    ...
    class DCR_T : public Register::Register<TIM2_DCR::dcr_reg_type, BASE_ADDRESS + DCR_Offset> {
    ...
    class DMAR_T : public Register::Register<TIM2_DMAR::dmar_reg_type, BASE_ADDRESS + DMAR_Offset> {
