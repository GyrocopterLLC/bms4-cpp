#ifndef STM32F0X1_GPIOE_HPP_
#define STM32F0X1_GPIOE_HPP_
#pragma once
...
public:
    ...
    GPIOE() = default;
    GPIOE( const GPIOE& ) = delete;
    const GPIOE& operator=( const GPIOE& ) = delete;

    class MODER_T : public Register::Register<GPIOE_MODER::moder_reg_type, BASE_ADDRESS + MODER_Offset> {
    ...
    class OTYPER_T : public Register::Register<GPIOE_OTYPER::otyper_reg_type, BASE_ADDRESS + OTYPER_Offset> {
    ...
    class OSPEEDR_T : public Register::Register<GPIOE_OSPEEDR::ospeedr_reg_type, BASE_ADDRESS + OSPEEDR_Offset> {
    ...
    class PUPDR_T : public Register::Register<GPIOE_PUPDR::pupdr_reg_type, BASE_ADDRESS + PUPDR_Offset> {
    ...
    class IDR_T : public Register::Register<GPIOE_IDR::idr_reg_type, BASE_ADDRESS + IDR_Offset> {
    ...
    class ODR_T : public Register::Register<GPIOE_ODR::odr_reg_type, BASE_ADDRESS + ODR_Offset> {
    ...
    class BSRR_T : public Register::Register<GPIOE_BSRR::bsrr_reg_type, BASE_ADDRESS + BSRR_Offset> {
    ...
    class LCKR_T : public Register::Register<GPIOE_LCKR::lckr_reg_type, BASE_ADDRESS + LCKR_Offset> {
    ...
    class AFRL_T : public Register::Register<GPIOE_AFRL::afrl_reg_type, BASE_ADDRESS + AFRL_Offset> {
    ...
    class AFRH_T : public Register::Register<GPIOE_AFRH::afrh_reg_type, BASE_ADDRESS + AFRH_Offset> {
    ...
    class BRR_T : public Register::Register<GPIOE_BRR::brr_reg_type, BASE_ADDRESS + BRR_Offset> {
