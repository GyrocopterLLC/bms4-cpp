#ifndef STM32F0X1_TIM17_HPP_
#define STM32F0X1_TIM17_HPP_
#pragma once
...
public:
    ...
    TIM17() = default;
    TIM17( const TIM17& ) = delete;
    const TIM17& operator=( const TIM17& ) = delete;

    class CR1_T : public Register::Register<TIM17_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // control register 1
    public:
    ...
    class CR2_T : public Register::Register<TIM17_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // control register 2
    public:
    ...
    class DIER_T : public Register::Register<TIM17_DIER::dier_reg_type, BASE_ADDRESS + DIER_Offset> {
    ...
    class SR_T : public Register::Register<TIM17_SR::sr_reg_type, BASE_ADDRESS + SR_Offset> {
    // status register
    public:
    ...
    class EGR_T : public Register::Register<TIM17_EGR::egr_reg_type, BASE_ADDRESS + EGR_Offset> {
    ...
    class CCMR1_Output_T : public Register::Register<TIM17_CCMR1_Output::ccmr1_output_reg_type, BASE_ADDRESS + CCMR1_Output_Offset> {
    ...
    class CCMR1_Input_T : public Register::Register<TIM17_CCMR1_Input::ccmr1_input_reg_type, BASE_ADDRESS + CCMR1_Input_Offset> {
    ...
    class CCER_T : public Register::Register<TIM17_CCER::ccer_reg_type, BASE_ADDRESS + CCER_Offset> {
    ...
    class CNT_T : public Register::Register<TIM17_CNT::cnt_reg_type, BASE_ADDRESS + CNT_Offset> {
    // counter
    public:
        Register::Bitfield<BASE_ADDRESS + CNT_Offset, 0, 16, CNT_CNT_T> CNT; /* counter value */
    };

    class PSC_T : public Register::Register<TIM17_PSC::psc_reg_type, BASE_ADDRESS + PSC_Offset> {
    // prescaler
    public:
        Register::Bitfield<BASE_ADDRESS + PSC_Offset, 0, 16, PSC_PSC_T> PSC; /* Prescaler value */
    };

    class ARR_T : public Register::Register<TIM17_ARR::arr_reg_type, BASE_ADDRESS + ARR_Offset> {
    // auto-reload register
    public:
        Register::Bitfield<BASE_ADDRESS + ARR_Offset, 0, 16, ARR_ARR_T> ARR; /* Auto-reload value */
    };

    class RCR_T : public Register::Register<TIM17_RCR::rcr_reg_type, BASE_ADDRESS + RCR_Offset> {
    // repetition counter register
    public:
        Register::Bitfield<BASE_ADDRESS + RCR_Offset, 0, 8, RCR_REP_T> REP; /* Repetition counter value */
    };

    class CCR1_T : public Register::Register<TIM17_CCR1::ccr1_reg_type, BASE_ADDRESS + CCR1_Offset> {
    // capture/compare register 1
    public:
        Register::Bitfield<BASE_ADDRESS + CCR1_Offset, 0, 16, CCR1_CCR1_T> CCR1; /* Capture/Compare 1 value */
    };

    class BDTR_T : public Register::Register<TIM17_BDTR::bdtr_reg_type, BASE_ADDRESS + BDTR_Offset> {
    ...
    class DCR_T : public Register::Register<TIM17_DCR::dcr_reg_type, BASE_ADDRESS + DCR_Offset> {
    ...
    class DMAR_T : public Register::Register<TIM17_DMAR::dmar_reg_type, BASE_ADDRESS + DMAR_Offset> {
