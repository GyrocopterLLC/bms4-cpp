#ifndef STM32F0X1_SPI2_HPP_
#define STM32F0X1_SPI2_HPP_
#pragma once
...
namespace SPI2_SR {
    ...
    template<bool tf>
    using CHSIDE = Register::Combo_Bit<sr_reg_type, 2, tf>;

    template<bool tf>
    using UDR = Register::Combo_Bit<sr_reg_type, 3, tf>;
...
public:
    ...
    SPI2() = default;
    SPI2( const SPI2& ) = delete;
    const SPI2& operator=( const SPI2& ) = delete;

    class CR1_T : public Register::Register<SPI2_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // control register 1
    public:
    ...
    class CR2_T : public Register::Register<SPI2_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // control register 2
    public:
    ...
    class SR_T : public Register::Register<SPI2_SR::sr_reg_type, BASE_ADDRESS + SR_Offset> {
    // status register
    public:
        ...
        Register::Bit<BASE_ADDRESS + SR_Offset, 2> CHSIDE; /* Channel side */
        Register::Bit<BASE_ADDRESS + SR_Offset, 3> UDR; /* Underrun flag */
    ...
    class DR_T : public Register::Register<SPI2_DR::dr_reg_type, BASE_ADDRESS + DR_Offset> {
    // data register
    public:
        Register::Bitfield<BASE_ADDRESS + DR_Offset, 0, 16, DR_DR_T> DR; /* Data register */
    };

    class CRCPR_T : public Register::Register<SPI2_CRCPR::crcpr_reg_type, BASE_ADDRESS + CRCPR_Offset> {
    // CRC polynomial register
    public:
        Register::Bitfield<BASE_ADDRESS + CRCPR_Offset, 0, 16, CRCPR_CRCPOLY_T> CRCPOLY; /* CRC polynomial register */
    };

    class RXCRCR_T : public Register::Register<SPI2_RXCRCR::rxcrcr_reg_type, BASE_ADDRESS + RXCRCR_Offset> {
    // RX CRC register
    public:
        Register::Bitfield<BASE_ADDRESS + RXCRCR_Offset, 0, 16, RXCRCR_RxCRC_T> RxCRC; /* Rx CRC register */
    };

    class TXCRCR_T : public Register::Register<SPI2_TXCRCR::txcrcr_reg_type, BASE_ADDRESS + TXCRCR_Offset> {
    // TX CRC register
    public:
        Register::Bitfield<BASE_ADDRESS + TXCRCR_Offset, 0, 16, TXCRCR_TxCRC_T> TxCRC; /* Tx CRC register */
    };

    class I2SCFGR_T : public Register::Register<SPI2_I2SCFGR::i2scfgr_reg_type, BASE_ADDRESS + I2SCFGR_Offset> {
    // I2S configuration register
    public:
        Register::Bit<BASE_ADDRESS + I2SCFGR_Offset, 11> I2SMOD; /* I2S mode selection */
        Register::Bit<BASE_ADDRESS + I2SCFGR_Offset, 10> I2SE; /* I2S Enable */
        Register::Bitfield<BASE_ADDRESS + I2SCFGR_Offset, 8, 2, I2SCFGR_I2SCFG_T> I2SCFG; /* I2S configuration mode */
        Register::Bit<BASE_ADDRESS + I2SCFGR_Offset, 7> PCMSYNC; /* PCM frame synchronization */
        Register::Bitfield<BASE_ADDRESS + I2SCFGR_Offset, 4, 2, I2SCFGR_I2SSTD_T> I2SSTD; /* I2S standard selection */
        Register::Bit<BASE_ADDRESS + I2SCFGR_Offset, 3> CKPOL; /* Steady state clock polarity */
        Register::Bitfield<BASE_ADDRESS + I2SCFGR_Offset, 1, 2, I2SCFGR_DATLEN_T> DATLEN; /* Data length to be transferred */
        Register::Bit<BASE_ADDRESS + I2SCFGR_Offset, 0> CHLEN; /* Channel length (number of bits per audio channel) */
    };

    class I2SPR_T : public Register::Register<SPI2_I2SPR::i2spr_reg_type, BASE_ADDRESS + I2SPR_Offset> {
    // I2S prescaler register
    public:
        Register::Bit<BASE_ADDRESS + I2SPR_Offset, 9> MCKOE; /* Master clock output enable */
        Register::Bit<BASE_ADDRESS + I2SPR_Offset, 8> ODD; /* Odd factor for the prescaler */
        Register::Bitfield<BASE_ADDRESS + I2SPR_Offset, 0, 8, I2SPR_I2SDIV_T> I2SDIV; /* I2S Linear prescaler */
    };
