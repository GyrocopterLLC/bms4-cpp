#ifndef STM32F0X1_DMA2_HPP_
#define STM32F0X1_DMA2_HPP_
#pragma once
...
public:
    ...
    DMA2() = default;
    DMA2( const DMA2& ) = delete;
    const DMA2& operator=( const DMA2& ) = delete;

    class ISR_T : public Register::Register<DMA2_ISR::isr_reg_type, BASE_ADDRESS + ISR_Offset> {
    ...
    class IFCR_T : public Register::Register<DMA2_IFCR::ifcr_reg_type, BASE_ADDRESS + IFCR_Offset> {
    ...
    class CCR1_T : public Register::Register<DMA2_CCR1::ccr1_reg_type, BASE_ADDRESS + CCR1_Offset> {
    ...
    class CNDTR1_T : public Register::Register<DMA2_CNDTR1::cndtr1_reg_type, BASE_ADDRESS + CNDTR1_Offset> {
    // DMA channel 1 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR1_Offset, 0, 16, CNDTR1_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR1_T : public Register::Register<DMA2_CPAR1::cpar1_reg_type, BASE_ADDRESS + CPAR1_Offset> {
    // DMA channel 1 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR1_Offset, 0, 32, CPAR1_PA_T> PA; /* Peripheral address */
    };

    class CMAR1_T : public Register::Register<DMA2_CMAR1::cmar1_reg_type, BASE_ADDRESS + CMAR1_Offset> {
    // DMA channel 1 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR1_Offset, 0, 32, CMAR1_MA_T> MA; /* Memory address */
    };

    class CCR2_T : public Register::Register<DMA2_CCR2::ccr2_reg_type, BASE_ADDRESS + CCR2_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR2_T : public Register::Register<DMA2_CNDTR2::cndtr2_reg_type, BASE_ADDRESS + CNDTR2_Offset> {
    // DMA channel 2 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR2_Offset, 0, 16, CNDTR2_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR2_T : public Register::Register<DMA2_CPAR2::cpar2_reg_type, BASE_ADDRESS + CPAR2_Offset> {
    // DMA channel 2 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR2_Offset, 0, 32, CPAR2_PA_T> PA; /* Peripheral address */
    };

    class CMAR2_T : public Register::Register<DMA2_CMAR2::cmar2_reg_type, BASE_ADDRESS + CMAR2_Offset> {
    // DMA channel 2 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR2_Offset, 0, 32, CMAR2_MA_T> MA; /* Memory address */
    };

    class CCR3_T : public Register::Register<DMA2_CCR3::ccr3_reg_type, BASE_ADDRESS + CCR3_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR3_T : public Register::Register<DMA2_CNDTR3::cndtr3_reg_type, BASE_ADDRESS + CNDTR3_Offset> {
    // DMA channel 3 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR3_Offset, 0, 16, CNDTR3_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR3_T : public Register::Register<DMA2_CPAR3::cpar3_reg_type, BASE_ADDRESS + CPAR3_Offset> {
    // DMA channel 3 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR3_Offset, 0, 32, CPAR3_PA_T> PA; /* Peripheral address */
    };

    class CMAR3_T : public Register::Register<DMA2_CMAR3::cmar3_reg_type, BASE_ADDRESS + CMAR3_Offset> {
    // DMA channel 3 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR3_Offset, 0, 32, CMAR3_MA_T> MA; /* Memory address */
    };

    class CCR4_T : public Register::Register<DMA2_CCR4::ccr4_reg_type, BASE_ADDRESS + CCR4_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR4_T : public Register::Register<DMA2_CNDTR4::cndtr4_reg_type, BASE_ADDRESS + CNDTR4_Offset> {
    // DMA channel 4 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR4_Offset, 0, 16, CNDTR4_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR4_T : public Register::Register<DMA2_CPAR4::cpar4_reg_type, BASE_ADDRESS + CPAR4_Offset> {
    // DMA channel 4 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR4_Offset, 0, 32, CPAR4_PA_T> PA; /* Peripheral address */
    };

    class CMAR4_T : public Register::Register<DMA2_CMAR4::cmar4_reg_type, BASE_ADDRESS + CMAR4_Offset> {
    // DMA channel 4 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR4_Offset, 0, 32, CMAR4_MA_T> MA; /* Memory address */
    };

    class CCR5_T : public Register::Register<DMA2_CCR5::ccr5_reg_type, BASE_ADDRESS + CCR5_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR5_T : public Register::Register<DMA2_CNDTR5::cndtr5_reg_type, BASE_ADDRESS + CNDTR5_Offset> {
    // DMA channel 5 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR5_Offset, 0, 16, CNDTR5_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR5_T : public Register::Register<DMA2_CPAR5::cpar5_reg_type, BASE_ADDRESS + CPAR5_Offset> {
    // DMA channel 5 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR5_Offset, 0, 32, CPAR5_PA_T> PA; /* Peripheral address */
    };

    class CMAR5_T : public Register::Register<DMA2_CMAR5::cmar5_reg_type, BASE_ADDRESS + CMAR5_Offset> {
    // DMA channel 5 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR5_Offset, 0, 32, CMAR5_MA_T> MA; /* Memory address */
    };

    class CCR6_T : public Register::Register<DMA2_CCR6::ccr6_reg_type, BASE_ADDRESS + CCR6_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR6_T : public Register::Register<DMA2_CNDTR6::cndtr6_reg_type, BASE_ADDRESS + CNDTR6_Offset> {
    // DMA channel 6 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR6_Offset, 0, 16, CNDTR6_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR6_T : public Register::Register<DMA2_CPAR6::cpar6_reg_type, BASE_ADDRESS + CPAR6_Offset> {
    // DMA channel 6 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR6_Offset, 0, 32, CPAR6_PA_T> PA; /* Peripheral address */
    };

    class CMAR6_T : public Register::Register<DMA2_CMAR6::cmar6_reg_type, BASE_ADDRESS + CMAR6_Offset> {
    // DMA channel 6 memory address register
    public:
        Register::Bitfield<BASE_ADDRESS + CMAR6_Offset, 0, 32, CMAR6_MA_T> MA; /* Memory address */
    };

    class CCR7_T : public Register::Register<DMA2_CCR7::ccr7_reg_type, BASE_ADDRESS + CCR7_Offset> {
    // DMA channel configuration register (DMA_CCR)
    public:
    ...
    class CNDTR7_T : public Register::Register<DMA2_CNDTR7::cndtr7_reg_type, BASE_ADDRESS + CNDTR7_Offset> {
    // DMA channel 7 number of data register
    public:
        Register::Bitfield<BASE_ADDRESS + CNDTR7_Offset, 0, 16, CNDTR7_NDT_T> NDT; /* Number of data to transfer */
    };

    class CPAR7_T : public Register::Register<DMA2_CPAR7::cpar7_reg_type, BASE_ADDRESS + CPAR7_Offset> {
    // DMA channel 7 peripheral address register
    public:
        Register::Bitfield<BASE_ADDRESS + CPAR7_Offset, 0, 32, CPAR7_PA_T> PA; /* Peripheral address */
    };

    class CMAR7_T : public Register::Register<DMA2_CMAR7::cmar7_reg_type, BASE_ADDRESS + CMAR7_Offset> {
