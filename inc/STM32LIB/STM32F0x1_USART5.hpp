#ifndef STM32F0X1_USART5_HPP_
#define STM32F0X1_USART5_HPP_
#pragma once
...
public:
    ...
    USART5() = default;
    USART5( const USART5& ) = delete;
    const USART5& operator=( const USART5& ) = delete;

    class CR1_T : public Register::Register<USART5_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // Control register 1
    public:
    ...
    class CR2_T : public Register::Register<USART5_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // Control register 2
    public:
    ...
    class CR3_T : public Register::Register<USART5_CR3::cr3_reg_type, BASE_ADDRESS + CR3_Offset> {
    // Control register 3
    public:
    ...
    class BRR_T : public Register::Register<USART5_BRR::brr_reg_type, BASE_ADDRESS + BRR_Offset> {
    // Baud rate register
    public:
    ...
    class GTPR_T : public Register::Register<USART5_GTPR::gtpr_reg_type, BASE_ADDRESS + GTPR_Offset> {
    ...
    class RTOR_T : public Register::Register<USART5_RTOR::rtor_reg_type, BASE_ADDRESS + RTOR_Offset> {
    ...
    class RQR_T : public Register::Register<USART5_RQR::rqr_reg_type, BASE_ADDRESS + RQR_Offset> {
    // Request register
    public:
    ...
    class ISR_T : public Register::Register<USART5_ISR::isr_reg_type, BASE_ADDRESS + ISR_Offset> {
    ...
    class ICR_T : public Register::Register<USART5_ICR::icr_reg_type, BASE_ADDRESS + ICR_Offset> {
    ...
    class RDR_T : public Register::Register<USART5_RDR::rdr_reg_type, BASE_ADDRESS + RDR_Offset> {
    // Receive data register
    public:
        Register::Bitfield<BASE_ADDRESS + RDR_Offset, 0, 9, RDR_RDR_T> RDR; /* Receive data value */
    };

    class TDR_T : public Register::Register<USART5_TDR::tdr_reg_type, BASE_ADDRESS + TDR_Offset> {
