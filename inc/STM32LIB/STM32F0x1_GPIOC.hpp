#ifndef STM32F0X1_GPIOC_HPP_
#define STM32F0X1_GPIOC_HPP_
#pragma once
...
using MODER_MODER15_T = uint32_t;
using MODER_MODER14_T = uint32_t;
using MODER_MODER13_T = uint32_t;
using MODER_MODER12_T = uint32_t;
using MODER_MODER11_T = uint32_t;
using MODER_MODER10_T = uint32_t;
using MODER_MODER9_T = uint32_t;
using MODER_MODER8_T = uint32_t;
using MODER_MODER7_T = uint32_t;
using MODER_MODER6_T = uint32_t;
using MODER_MODER5_T = uint32_t;
using MODER_MODER4_T = uint32_t;
using MODER_MODER3_T = uint32_t;
using MODER_MODER2_T = uint32_t;
using MODER_MODER1_T = uint32_t;
using MODER_MODER0_T = uint32_t;
using OSPEEDR_OSPEEDR15_T = uint32_t;
using OSPEEDR_OSPEEDR14_T = uint32_t;
using OSPEEDR_OSPEEDR13_T = uint32_t;
using OSPEEDR_OSPEEDR12_T = uint32_t;
using OSPEEDR_OSPEEDR11_T = uint32_t;
using OSPEEDR_OSPEEDR10_T = uint32_t;
using OSPEEDR_OSPEEDR9_T = uint32_t;
using OSPEEDR_OSPEEDR8_T = uint32_t;
using OSPEEDR_OSPEEDR7_T = uint32_t;
using OSPEEDR_OSPEEDR6_T = uint32_t;
using OSPEEDR_OSPEEDR5_T = uint32_t;
using OSPEEDR_OSPEEDR4_T = uint32_t;
using OSPEEDR_OSPEEDR3_T = uint32_t;
using OSPEEDR_OSPEEDR2_T = uint32_t;
using OSPEEDR_OSPEEDR1_T = uint32_t;
using OSPEEDR_OSPEEDR0_T = uint32_t;
using PUPDR_PUPDR15_T = uint32_t;
using PUPDR_PUPDR14_T = uint32_t;
using PUPDR_PUPDR13_T = uint32_t;
using PUPDR_PUPDR12_T = uint32_t;
using PUPDR_PUPDR11_T = uint32_t;
using PUPDR_PUPDR10_T = uint32_t;
using PUPDR_PUPDR9_T = uint32_t;
using PUPDR_PUPDR8_T = uint32_t;
using PUPDR_PUPDR7_T = uint32_t;
using PUPDR_PUPDR6_T = uint32_t;
using PUPDR_PUPDR5_T = uint32_t;
using PUPDR_PUPDR4_T = uint32_t;
using PUPDR_PUPDR3_T = uint32_t;
using PUPDR_PUPDR2_T = uint32_t;
using PUPDR_PUPDR1_T = uint32_t;
using PUPDR_PUPDR0_T = uint32_t;
...
public:
    ...
    GPIOC() = default;
    GPIOC( const GPIOC& ) = delete;
    const GPIOC& operator=( const GPIOC& ) = delete;

    class MODER_T : public Register::Register<GPIOC_MODER::moder_reg_type, BASE_ADDRESS + MODER_Offset> {
    ...
    class OTYPER_T : public Register::Register<GPIOC_OTYPER::otyper_reg_type, BASE_ADDRESS + OTYPER_Offset> {
    // GPIO port output type register
    public:
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 15> OT15; /* Port x configuration bit 15 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 14> OT14; /* Port x configuration bit 14 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 13> OT13; /* Port x configuration bit 13 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 12> OT12; /* Port x configuration bit 12 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 11> OT11; /* Port x configuration bit 11 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 10> OT10; /* Port x configuration bit 10 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 9> OT9; /* Port x configuration bit 9 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 8> OT8; /* Port x configuration bit 8 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 7> OT7; /* Port x configuration bit 7 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 6> OT6; /* Port x configuration bit 6 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 5> OT5; /* Port x configuration bit 5 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 4> OT4; /* Port x configuration bit 4 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 3> OT3; /* Port x configuration bit 3 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 2> OT2; /* Port x configuration bit 2 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 1> OT1; /* Port x configuration bit 1 */
        Register::Bit<BASE_ADDRESS + OTYPER_Offset, 0> OT0; /* Port x configuration bit 0 */
    };

    class OSPEEDR_T : public Register::Register<GPIOC_OSPEEDR::ospeedr_reg_type, BASE_ADDRESS + OSPEEDR_Offset> {
    ...
    class PUPDR_T : public Register::Register<GPIOC_PUPDR::pupdr_reg_type, BASE_ADDRESS + PUPDR_Offset> {
    ...
    class IDR_T : public Register::Register<GPIOC_IDR::idr_reg_type, BASE_ADDRESS + IDR_Offset> {
    ...
    class ODR_T : public Register::Register<GPIOC_ODR::odr_reg_type, BASE_ADDRESS + ODR_Offset> {
    ...
    class BSRR_T : public Register::Register<GPIOC_BSRR::bsrr_reg_type, BASE_ADDRESS + BSRR_Offset> {
    ...
    class LCKR_T : public Register::Register<GPIOC_LCKR::lckr_reg_type, BASE_ADDRESS + LCKR_Offset> {
    // GPIO port configuration lock register
    public:
        Register::Bit<BASE_ADDRESS + LCKR_Offset, 16> LCKK; /* Port x lock bit y */
    ...
    class AFRL_T : public Register::Register<GPIOC_AFRL::afrl_reg_type, BASE_ADDRESS + AFRL_Offset> {
    ...
    class AFRH_T : public Register::Register<GPIOC_AFRH::afrh_reg_type, BASE_ADDRESS + AFRH_Offset> {
    ...
    class BRR_T : public Register::Register<GPIOC_BRR::brr_reg_type, BASE_ADDRESS + BRR_Offset> {
    // Port bit reset register
    public:
        Register::Bit<BASE_ADDRESS + BRR_Offset, 0> BR0; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 1> BR1; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 2> BR2; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 3> BR3; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 4> BR4; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 5> BR5; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 6> BR6; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 7> BR7; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 8> BR8; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 9> BR9; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 10> BR10; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 11> BR11; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 12> BR12; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 13> BR13; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 14> BR14; /* Port x Reset bit y */
        Register::Bit<BASE_ADDRESS + BRR_Offset, 15> BR15; /* Port x Reset bit y */
    };
