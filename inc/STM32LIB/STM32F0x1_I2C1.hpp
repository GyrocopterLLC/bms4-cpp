#ifndef STM32F0X1_I2C1_HPP_
#define STM32F0X1_I2C1_HPP_
#pragma once
...
public:
    ...
    I2C1() = default;
    I2C1( const I2C1& ) = delete;
    const I2C1& operator=( const I2C1& ) = delete;

    class CR1_T : public Register::Register<I2C1_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // Control register 1
    public:
    ...
    class CR2_T : public Register::Register<I2C1_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // Control register 2
    public:
    ...
    class OAR1_T : public Register::Register<I2C1_OAR1::oar1_reg_type, BASE_ADDRESS + OAR1_Offset> {
    ...
    class OAR2_T : public Register::Register<I2C1_OAR2::oar2_reg_type, BASE_ADDRESS + OAR2_Offset> {
    ...
    class TIMINGR_T : public Register::Register<I2C1_TIMINGR::timingr_reg_type, BASE_ADDRESS + TIMINGR_Offset> {
    // Timing register
    public:
    ...
    class TIMEOUTR_T : public Register::Register<I2C1_TIMEOUTR::timeoutr_reg_type, BASE_ADDRESS + TIMEOUTR_Offset> {
    // Status register 1
    public:
    ...
    class ISR_T : public Register::Register<I2C1_ISR::isr_reg_type, BASE_ADDRESS + ISR_Offset> {
    ...
    class ICR_T : public Register::Register<I2C1_ICR::icr_reg_type, BASE_ADDRESS + ICR_Offset> {
    ...
    class PECR_T : public Register::Register<I2C1_PECR::pecr_reg_type, BASE_ADDRESS + PECR_Offset> {
    // PEC register
    public:
        Register::Bitfield<BASE_ADDRESS + PECR_Offset, 0, 8, PECR_PEC_T> PEC; /* Packet error checking register */
    };

    class RXDR_T : public Register::Register<I2C1_RXDR::rxdr_reg_type, BASE_ADDRESS + RXDR_Offset> {
    // Receive data register
    public:
        Register::Bitfield<BASE_ADDRESS + RXDR_Offset, 0, 8, RXDR_RXDATA_T> RXDATA; /* 8-bit receive data */
    };

    class TXDR_T : public Register::Register<I2C1_TXDR::txdr_reg_type, BASE_ADDRESS + TXDR_Offset> {
