#ifndef STM32F0X1_GPIOB_HPP_
#define STM32F0X1_GPIOB_HPP_
#pragma once
...
public:
    ...
    GPIOB() = default;
    GPIOB( const GPIOB& ) = delete;
    const GPIOB& operator=( const GPIOB& ) = delete;

    class MODER_T : public Register::Register<GPIOB_MODER::moder_reg_type, BASE_ADDRESS + MODER_Offset> {
    ...
    class OTYPER_T : public Register::Register<GPIOB_OTYPER::otyper_reg_type, BASE_ADDRESS + OTYPER_Offset> {
    ...
    class OSPEEDR_T : public Register::Register<GPIOB_OSPEEDR::ospeedr_reg_type, BASE_ADDRESS + OSPEEDR_Offset> {
    ...
    class PUPDR_T : public Register::Register<GPIOB_PUPDR::pupdr_reg_type, BASE_ADDRESS + PUPDR_Offset> {
    ...
    class IDR_T : public Register::Register<GPIOB_IDR::idr_reg_type, BASE_ADDRESS + IDR_Offset> {
    ...
    class ODR_T : public Register::Register<GPIOB_ODR::odr_reg_type, BASE_ADDRESS + ODR_Offset> {
    ...
    class BSRR_T : public Register::Register<GPIOB_BSRR::bsrr_reg_type, BASE_ADDRESS + BSRR_Offset> {
    ...
    class LCKR_T : public Register::Register<GPIOB_LCKR::lckr_reg_type, BASE_ADDRESS + LCKR_Offset> {
    ...
    class AFRL_T : public Register::Register<GPIOB_AFRL::afrl_reg_type, BASE_ADDRESS + AFRL_Offset> {
    ...
    class AFRH_T : public Register::Register<GPIOB_AFRH::afrh_reg_type, BASE_ADDRESS + AFRH_Offset> {
    ...
    class BRR_T : public Register::Register<GPIOB_BRR::brr_reg_type, BASE_ADDRESS + BRR_Offset> {
