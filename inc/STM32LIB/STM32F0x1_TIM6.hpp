#ifndef STM32F0X1_TIM6_HPP_
#define STM32F0X1_TIM6_HPP_
#pragma once
...
public:
    ...
    TIM6() = default;
    TIM6( const TIM6& ) = delete;
    const TIM6& operator=( const TIM6& ) = delete;

    class CR1_T : public Register::Register<TIM6_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // control register 1
    public:
    ...
    class CR2_T : public Register::Register<TIM6_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // control register 2
    public:
        Register::Bitfield<BASE_ADDRESS + CR2_Offset, 4, 3, CR2_MMS_T> MMS; /* Master mode selection */
    };

    class DIER_T : public Register::Register<TIM6_DIER::dier_reg_type, BASE_ADDRESS + DIER_Offset> {
    ...
    class SR_T : public Register::Register<TIM6_SR::sr_reg_type, BASE_ADDRESS + SR_Offset> {
    // status register
    public:
        Register::Bit<BASE_ADDRESS + SR_Offset, 0> UIF; /* Update interrupt flag */
    };

    class EGR_T : public Register::Register<TIM6_EGR::egr_reg_type, BASE_ADDRESS + EGR_Offset> {
    // event generation register
    public:
        Register::Bit<BASE_ADDRESS + EGR_Offset, 0> UG; /* Update generation */
    };

    class CNT_T : public Register::Register<TIM6_CNT::cnt_reg_type, BASE_ADDRESS + CNT_Offset> {
    // counter
    public:
        Register::Bitfield<BASE_ADDRESS + CNT_Offset, 0, 16, CNT_CNT_T> CNT; /* Low counter value */
    };

    class PSC_T : public Register::Register<TIM6_PSC::psc_reg_type, BASE_ADDRESS + PSC_Offset> {
    // prescaler
    public:
        Register::Bitfield<BASE_ADDRESS + PSC_Offset, 0, 16, PSC_PSC_T> PSC; /* Prescaler value */
    };

    class ARR_T : public Register::Register<TIM6_ARR::arr_reg_type, BASE_ADDRESS + ARR_Offset> {
