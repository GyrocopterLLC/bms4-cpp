#ifndef STM32F0X1_SPI1_HPP_
#define STM32F0X1_SPI1_HPP_
#pragma once
...
public:
    ...
    const SPI1& operator=( const SPI1& ) = delete;

    class CR1_T : public Register::Register<SPI1_CR1::cr1_reg_type, BASE_ADDRESS + CR1_Offset> {
    // control register 1
    public:
    ...
    class CR2_T : public Register::Register<SPI1_CR2::cr2_reg_type, BASE_ADDRESS + CR2_Offset> {
    // control register 2
    public:
    ...
    class SR_T : public Register::Register<SPI1_SR::sr_reg_type, BASE_ADDRESS + SR_Offset> {
    // status register
    public:
    ...
    class DR_T : public Register::Register<SPI1_DR::dr_reg_type, BASE_ADDRESS + DR_Offset> {
    // data register
    public:
        Register::Bitfield<BASE_ADDRESS + DR_Offset, 0, 16, DR_DR_T> DR; /* Data register */
    };

    class CRCPR_T : public Register::Register<SPI1_CRCPR::crcpr_reg_type, BASE_ADDRESS + CRCPR_Offset> {
    // CRC polynomial register
    public:
        Register::Bitfield<BASE_ADDRESS + CRCPR_Offset, 0, 16, CRCPR_CRCPOLY_T> CRCPOLY; /* CRC polynomial register */
    };

    class RXCRCR_T : public Register::Register<SPI1_RXCRCR::rxcrcr_reg_type, BASE_ADDRESS + RXCRCR_Offset> {
    // RX CRC register
    public:
        Register::Bitfield<BASE_ADDRESS + RXCRCR_Offset, 0, 16, RXCRCR_RxCRC_T> RxCRC; /* Rx CRC register */
    };

    class TXCRCR_T : public Register::Register<SPI1_TXCRCR::txcrcr_reg_type, BASE_ADDRESS + TXCRCR_Offset> {
    // TX CRC register
    public:
        Register::Bitfield<BASE_ADDRESS + TXCRCR_Offset, 0, 16, TXCRCR_TxCRC_T> TxCRC; /* Tx CRC register */
    };

    class I2SCFGR_T : public Register::Register<SPI1_I2SCFGR::i2scfgr_reg_type, BASE_ADDRESS + I2SCFGR_Offset> {
    ...
    class I2SPR_T : public Register::Register<SPI1_I2SPR::i2spr_reg_type, BASE_ADDRESS + I2SPR_Offset> {
